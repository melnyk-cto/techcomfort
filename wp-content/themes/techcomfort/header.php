            ...
            <div class='header-top-inner'>
                <nav class='header-menu'>
                    <ul class='menu-list'>
                        ...
                        <!--                        <li class='menu-item'>-->
                        <!--                            <a href='-->
                        <?php //echo home_url('/'); ?><!--reviews'>Отзывы</a>-->
                        <!--                        </li>-->
                        <!--                        <li class='menu-item'>-->
            ...
            <div class='bottom-inner'>
                ...
                <div class='header-menu'>
                    <div class='header-actions'>
                        <!--                        <a href='-->
                        <?php //echo home_url('/'); ?><!--personal-area' class='header-item header-profile'>-->
                        ...
                        <!--                        </a>-->
                        <!--                        <a href='-->
                        <?php //echo home_url('/'); ?><!--personal-area' class='header-item header-ordering'>-->
                        ...
                        <!--                        </a>-->
                        <!--                        <a href='-->
                        <?php //echo home_url('/'); ?><!--comparison' class='header-item header-comparison'>-->
                        ...
                        <!--                        </a>-->
                        <!--                        <a href='-->
                        <?php //echo home_url('/'); ?><!--personal-area' class='header-item header-favorites'>-->
                        ...
                        <!--                        </a>-->
                        <!--                        <a href='-->
                        <?php //echo home_url('/'); ?><!--personal-area' class='header-item header-viewed'>-->
                        ...
                        <!--                        </a>-->
                        <!--                        <a href='-->
                        <?php //echo home_url('/'); ?><!--personal-area' class='header-item header-reviews'>-->
                    ...
                    <nav class='menu'>
                        <ul>
                            ...
                            <!--                            <li>-->
                            <!--                                <a class='menu-item header-item' href='-->
                            <?php //echo home_url('/'); ?><!--reviews'>Отзывы</a>-->
                            <!--                            </li>-->
                            <!--                            <li>-->
                            <!--                                <a class='menu-item header-item' href='-->
