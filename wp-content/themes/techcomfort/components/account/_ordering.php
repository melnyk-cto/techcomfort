<?php
    ...
    foreach ($orders as $order) {
        if (intval(get_field('order_user_id', $order->get_id())) === get_current_user_id()) {
                ...
                <div class='order-history'>
                    <div class='order-history-left'>
                        ...
                        <ul>
                            ...
                            <li>
                                Требуется установка:
                                <span><?php echo get_field('order_installation', $order->get_id()) ?></span>
                            </li>
        ...
        <?php } ?>
    <?php } ?>
<?php if ($count === 0) echo '<h3>Список заказов пуст</h3>' ?>
