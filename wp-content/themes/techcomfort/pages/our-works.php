            ...
            <div class='header-bottom-inner'>
                <div class='header-catalog'>
                    ...
                    <div class='catalog-submenu'>
                        <a href='<?php echo home_url( '/' ); ?>product-page' class='submenu-item'>
                ...
                <div class='header-action'>
                    <a href='<?php echo home_url( '/' ); ?>personal-area' class='header-profile'>
            ...
            <div class='bottom-inner'>
                ...
                <nav class='header-menu'>
                    <ul>
                        ...
                        <li>
                            <a class='menu-item header-item' href='<?php echo home_url( '/' ); ?>installation-and-assembly'>Установка и
                                монтаж</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class='menu-item header-item' href='<?php echo home_url( '/' ); ?>payment-and-delivery'>Оплата и доствка</a>
                        </li>
                        <li>
                            <a class='menu-item header-item' href='#'>Наши роботы</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class='menu-item header-item' href='<?php echo home_url( '/' ); ?>contacts'>Контакты</a>
                        </li>
                    </ul>
                </nav>
        ...
        <div class='container'>
            ...
            <div id='grid' data-columns class='clearfix'>
                <div class="gallery-item">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-1.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item grid-item--width2">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-2.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-3.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-4.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item grid-item--width2">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-5.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-6.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item grid-item--width2">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-7.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-8.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-9.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item grid-item--width2">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-10.jpg' alt='Кондиционер'>
                </div>
                <div class="gallery-item">
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/gallery-image-11.jpg' alt='Кондиционер'>
                </div>
            </div>
        </div>
    </section>
