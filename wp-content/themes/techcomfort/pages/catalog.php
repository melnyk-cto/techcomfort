...
<head>
    ...
    <link rel='stylesheet' href='../assets/lib/nouislider.css'>
</head>
<body>
<header class='header'>
            ...
            <div class='bottom-inner'>
                ...
                <nav class='header-menu'>
                    <ul>
                        ...
                        <li>
                            <a class='menu-item header-item' href='#'>Каталог</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class='menu-item header-item' href='<?php echo home_url( '/' ); ?>our-works'>Наши роботы</a>
                        </li>
                        <li>
...
<script src='../assets/lib/nouislider.js'></script>
