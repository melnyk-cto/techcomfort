...
<head>
    ...
    <title>Установка и монтаж</title>
            ...
            <div class='bottom-inner'>
                ...
                <nav class='header-menu'>
                    <ul>
                        ...
                        <li>
                            <a class='menu-item header-item' href='#'>Установка и
                                монтаж</a>
                        </li>
                        <li>
        ...
        <div class='container'>
            <div class='installation-inner'>
                ...
                <div class='installation-image'>
                    <img src='<?php echo get_template_directory_uri() ?>/assets/images/installation-image.jpg' alt='Установка кондиционера'>
                </div>
            </div>
        </div>
    </section>
